...
well, but when in doubt, err on the side of more verbosity. Besides the
versions of all software packages involved (on both machines), the download
cradle parameters will be particularly important.
